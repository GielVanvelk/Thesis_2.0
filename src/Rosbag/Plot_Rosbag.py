...
bag = rosbag.Bag('0.5_2446.9071717866.bag')

create_figures = True
open_figures = False #True

##################################### STATE ORDER
safety_check = 0
move_to_home = 1
idle = 2
sensor_compensation = 3
idle = 4
move_to_start = 5
stiffness_calculation = 6
scanning = 7
finished = 8
...
stiffness_calc_start_time = state_list_sep[stiffness_calculation]
