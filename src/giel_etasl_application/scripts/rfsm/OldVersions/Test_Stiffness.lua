...
starting_pose = {-0.4, 0, 0.25, 3.14, 0, 3.14}  --[m]
...
return rfsm.state {
	...
	rfsm.trans {src="apply_force",               tgt="error",   				   events={'e_finished@etaslcore'}  },
	rfsm.trans {src="apply_force",               tgt="error",   				   events={'e_forceReached'}        },
