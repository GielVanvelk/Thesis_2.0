...
return rfsm.state {
	...
	-- FORCE CONTROL
	--==============================================================================================================
	force_control = rfsm.state {
		entry=function()
			print('Starting force_control')
			state_force_control(max_vel, max_acc, force_setpoint)
			rtt.sleep(2,0) --Sleep for 2 seconds
		end,
		exit=function()
			etaslcore:stop()
	...
	rfsm.trans {src="move_to_starting_pose",     tgt="force_control",              events={'e_finished@etaslcore'}  },
